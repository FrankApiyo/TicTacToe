...
return (new CustomEvent(event_name,(function (){var obj33244 = ({"detail":data});
return obj33244;
})()));
} else {
...
var f = (function (){var pred__33251 = cljs.core._EQ_;
var expr__33252 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33251.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33252))){
return ((function (pred__33251,expr__33252){
return (function (p1__33245_SHARP_){
return console.warn(p1__33245_SHARP_);
});
;})(pred__33251,expr__33252))
} else {
if(cljs.core.truth_(pred__33251.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__33252))){
return ((function (pred__33251,expr__33252){
return (function (p1__33246_SHARP_){
return console.debug(p1__33246_SHARP_);
});
;})(pred__33251,expr__33252))
} else {
if(cljs.core.truth_(pred__33251.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__33252))){
return ((function (pred__33251,expr__33252){
return (function (p1__33247_SHARP_){
return console.error(p1__33247_SHARP_);
});
;})(pred__33251,expr__33252))
} else {
return ((function (pred__33251,expr__33252){
return (function (p1__33248_SHARP_){
return console.log(p1__33248_SHARP_);
});
;})(pred__33251,expr__33252))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33255){
...
var opts = map__33256__$1;
var eval_fn = cljs.core.get.call(null,map__33256__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33258_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__33260,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1580192144019
