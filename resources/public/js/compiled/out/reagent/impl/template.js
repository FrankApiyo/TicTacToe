...
var G__21547 = o;
(G__21547[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__21549__i < G__21549__a.length) {G__21549__a[G__21549__i] = arguments[G__21549__i + 0]; ++G__21549__i;}
  args = new cljs.core.IndexedSeq(G__21549__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21550);
...
var G__21551 = o;
(G__21551[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21556 = props;
var G__21556__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21556,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21556);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21556__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21557){
...
var props = map__21558__$1;
var class$ = cljs.core.get.call(null,map__21558__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21558,map__21558__$1,props,class$){
return (function (c){
...
});})(map__21558,map__21558__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21560){
...
var on_write = cljs.core.get.call(null,map__21561__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21561,map__21561__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21561,map__21561__$1,on_write))
);
} else {
...
var G__21564 = jsprops;
(G__21564["defaultValue"] = value);

(G__21564["onChange"] = ((function (G__21564,v,value,on_change){
return (function (p1__21563_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21563_SHARP_);
});})(G__21564,v,value,on_change))
);
...
var vec__21567 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21567,(0),null);
var id = cljs.core.nth.call(null,vec__21567,(1),null);
var class$ = cljs.core.nth.call(null,vec__21567,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___21571 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___21571 == null)){
} else {
var key_21572 = temp__5724__auto___21571;
(jsprops["key"] = key_21572);
}
...
var temp__5724__auto___21573 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___21573 == null)){
} else {
var key_21574 = temp__5724__auto___21573;
reagent.impl.template.oset.call(null,jsprops,"key",key_21574);
}
...
var G__21575 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21575["name"] = c);
...
var len__4730__auto___21581 = arguments.length;
var i__4731__auto___21582 = (0);
while(true){
if((i__4731__auto___21582 < len__4730__auto___21581)){
args__4736__auto__.push((arguments[i__4731__auto___21582]));

var G__21583 = (i__4731__auto___21582 + (1));
i__4731__auto___21582 = G__21583;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21579){
...
break;
default:
var G__21586 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21586;
continue;
...
var n__4607__auto___21588 = a.length;
var i_21589 = (0);
while(true){
if((i_21589 < n__4607__auto___21588)){
(a[i_21589] = reagent.impl.template.as_element.call(null,(a[i_21589])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21591 = a.length;
var i_21592 = (0);
while(true){
if((i_21592 < n__4607__auto___21591)){
var val_21593 = (a[i_21592]);
if(((cljs.core.vector_QMARK_.call(null,val_21593)) && ((reagent.impl.template.key_from_vec.call(null,val_21593) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21592] = reagent.impl.template.as_element.call(null,val_21593));
...
var ctx = ({});
var vec__21595 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21595,(0),null);
var derefed = cljs.core.nth.call(null,vec__21595,(1),null);
...
var G__21598 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21598) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21598){
...
//# sourceMappingURL=template.js.map?rel=1580192134108
