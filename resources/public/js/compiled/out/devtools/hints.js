...
}catch (e27727){var _e = e27727;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___27730 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___27730)){
var seen_errors_27731 = temp__5718__auto___27730;
if(cljs.core.truth_(seen_errors_27731.has(self))){
} else {
seen_errors_27731.add(self);

var temp__5720__auto___27732 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___27732)){
var sense_27733 = temp__5720__auto___27732;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27733)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1580192141600
