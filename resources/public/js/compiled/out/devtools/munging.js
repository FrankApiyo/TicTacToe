...
var o22913 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22913["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22914 = temp__5718__auto____$1;
return (o22914["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21842__auto__ = f;
return (o__21842__auto__["toString"]).call(o__21842__auto__);
} else {
return "";
}
}catch (e22915){var _ = e22915;
return "";
}});
...
try{var o__21842__auto___22917 = t;
(o__21842__auto___22917["cljs$lang$ctorPrWriter"]).call(o__21842__auto___22917,t,writer);
}catch (e22916){var __22918 = e22916;
}
...
var char_code = (function (){var o__21842__auto__ = (new String(char$));
return (o__21842__auto__["charCodeAt"]).call(o__21842__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21842__auto__ = String;
return (o__21842__auto__["fromCharCode"]).call(o__21842__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22919 = num_code;
switch (G__22919) {
case (1):
return (185);
...
var o__21842__auto__ = String;
return (o__21842__auto__["fromCharCode"]).call(o__21842__auto__,superscript_code);
});
/**
...
}catch (e22921){var _e__21849__auto__ = e22921;
return false;
}})())){
...
var vec__22922 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22922,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22925 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22925["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22926 = temp__5718__auto____$1;
return (o22926["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22933 = arguments.length;
var i__4731__auto___22934 = (0);
while(true){
if((i__4731__auto___22934 < len__4730__auto___22933)){
args__4736__auto__.push((arguments[i__4731__auto___22934]));

var G__22935 = (i__4731__auto___22934 + (1));
i__4731__auto___22934 = G__22935;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22929){
var vec__22930 = p__22929;
var ns_detector = cljs.core.nth.call(null,vec__22930,(0),null);
...
var G__22936 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22937 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22936;
remaining_tokens = G__22937;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22927){
...
var vec__22941 = cljs.core.split_with.call(null,(function (p1__22940_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22940_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22941,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22941,(1),null);
...
var vec__22947 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22947,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22947,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22950 = cljs.core.rest.call(null,remaining_tokens);
var G__22951 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22950;
name_tokens = G__22951;
continue;
} else {
...
var vec__22954 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22954,(0),null);
var arity = cljs.core.nth.call(null,vec__22954,(1),null);
var vec__22957 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22957,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22957,(1),null);
var vec__22960 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22960,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22960,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22960,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22960,(3),null);
...
var vec__22966 = result;
var munged_ns = cljs.core.nth.call(null,vec__22966,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22966,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22966,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22966,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22966,(4),null);
var arity = cljs.core.nth.call(null,vec__22966,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22970 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22970,(0),null);
var args = cljs.core.nth.call(null,vec__22970,(1),null);
var vec__22973 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22973,(0),null);
var name = cljs.core.nth.call(null,vec__22973,(1),null);
...
var G__22976 = (arity + (1));
var G__22977 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22978){
var vec__22979 = p__22978;
var arity = cljs.core.nth.call(null,vec__22979,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22979,(1),null);
...
return cljs.core.get.call(null,arities,p1__22982_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22983_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22986){
var vec__22987 = p__22986;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22987,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22984){
var G__22985 = cljs.core.first.call(null,seq22984);
var seq22984__$1 = cljs.core.next.call(null,seq22984);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22985,seq22984__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22995__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22995__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22995__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22995__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22996 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22996,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22996,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22996,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22996,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22996,(4),null);
var arity = cljs.core.nth.call(null,vec__22996,(5),null);
...
var o__21842__auto__ = f;
return (o__21842__auto__["getBasis"]).call(o__21842__auto__);
});
/**
...
}catch (e23000){var _e__21849__auto__ = e23000;
...
var G__23001 = (obj[cljs.core.first.call(null,path)]);
var G__23002 = cljs.core.rest.call(null,path);
obj = G__23001;
path = G__23002;
continue;
} else {
...
return (function (accum,p__23003){
var vec__23004 = p__23003;
var bit = cljs.core.nth.call(null,vec__23004,(0),null);
var protocol = cljs.core.nth.call(null,vec__23004,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23007){
...
var selector = cljs.core.nth.call(null,vec__23008,(2),null);
...
return (function (p__23012){
var vec__23013 = p__23012;
var munged_name = cljs.core.nth.call(null,vec__23013,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23013,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23013,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23011_SHARP_){
return (obj[cljs.core.first.call(null,p1__23011_SHARP_)]);
});})(name,sorted_matches,vec__23013,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1580192135617
